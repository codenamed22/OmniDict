...
const file_proto_kv_proto_rawDesc = "" +
	...
	"\baccepted\x18\x01 \x01(\bR\baccepted2\x84\x01\n" +
	"\aKVStore\x12&\n" +
	"\x03Put\x12\x0e.kv.PutRequest\x1a\x0f.kv.PutResponse\x12&\n" +
	"\x03Get\x12\x0e.kv.GetRequest\x1a\x0f.kv.GetResponse\x12)\n" +
	"\x04Join\x12\x0f.kv.JoinRequest\x1a\x10.kv.JoinResponseB\x13Z\x11omnidict/proto;kvb\x06proto3"
...
var file_proto_kv_proto_depIdxs = []int32{
	...
	4, // 2: kv.KVStore.Join:input_type -> kv.JoinRequest
	1, // 3: kv.KVStore.Put:output_type -> kv.PutResponse
	3, // 4: kv.KVStore.Get:output_type -> kv.GetResponse
	5, // 5: kv.KVStore.Join:output_type -> kv.JoinResponse
