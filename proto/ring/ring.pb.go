//protoc --go_out=./proto --go-grpc_out=./proto proto/kv.proto - for regerenerating Go code - go to proto directory
...
func (x *RemoveNodeResponse) Reset() {
	*x = RemoveNodeResponse{}
	mi := &file_proto_ring_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RemoveNodeResponse) Descriptor() ([]byte, []int) {
	return file_proto_ring_proto_rawDescGZIP(), []int{9}
}
...
func (x *GetShardRequest) Reset() {
	*x = GetShardRequest{}
	mi := &file_proto_ring_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetShardRequest) Descriptor() ([]byte, []int) {
	return file_proto_ring_proto_rawDescGZIP(), []int{10}
}
...
func (x *GetShardResponse) Reset() {
	*x = GetShardResponse{}
	mi := &file_proto_ring_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetShardResponse) Descriptor() ([]byte, []int) {
	return file_proto_ring_proto_rawDescGZIP(), []int{11}
}

func (x *GetShardResponse) GetShardId() string {
	if x != nil {
		return x.ShardId
	}
	return ""
...
const file_proto_ring_proto_rawDesc = "" +
	"\n" +
	"\x10proto/ring.proto\x12\x04ring\"F\n" +
	"\n" +
	"PutRequest\x12\x10\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\"-\n" +
	"\x10GetShardResponse\x12\x19\n" +
	"\bshard_id\x18\x01 \x01(\tR\ashardId2\xce\x02\n" +
	"\vRingService\x12*\n" +
	"\x03Put\x12\x10.ring.PutRequest\x1a\x11.ring.PutResponse\x12*\n" +
	"\x03Get\x12\x10.ring.GetRequest\x1a\x11.ring.GetResponse\x123\n" +
	"\x06Delete\x12\x13.ring.DeleteRequest\x1a\x14.ring.DeleteResponse\x126\n" +
	"\aAddNode\x12\x14.ring.AddNodeRequest\x1a\x15.ring.AddNodeResponse\x12?\n" +
	"\n" +
	"RemoveNode\x12\x17.ring.RemoveNodeRequest\x1a\x18.ring.RemoveNodeResponse\x129\n" +
	"\bGetShard\x12\x15.ring.GetShardRequest\x1a\x16.ring.GetShardResponseB\bZ\x06./ringb\x06proto3"
...
var file_proto_ring_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_proto_ring_proto_goTypes = []any{
	(*PutRequest)(nil),         // 0: ring.PutRequest
	(*PutResponse)(nil),        // 1: ring.PutResponse
	(*GetRequest)(nil),         // 2: ring.GetRequest
	(*GetResponse)(nil),        // 3: ring.GetResponse
	(*DeleteRequest)(nil),      // 4: ring.DeleteRequest
	(*DeleteResponse)(nil),     // 5: ring.DeleteResponse
	(*AddNodeRequest)(nil),     // 6: ring.AddNodeRequest
	(*AddNodeResponse)(nil),    // 7: ring.AddNodeResponse
	(*RemoveNodeRequest)(nil),  // 8: ring.RemoveNodeRequest
	(*RemoveNodeResponse)(nil), // 9: ring.RemoveNodeResponse
	(*GetShardRequest)(nil),    // 10: ring.GetShardRequest
	(*GetShardResponse)(nil),   // 11: ring.GetShardResponse
}
var file_proto_ring_proto_depIdxs = []int32{
	0,  // 0: ring.RingService.Put:input_type -> ring.PutRequest
	2,  // 1: ring.RingService.Get:input_type -> ring.GetRequest
	4,  // 2: ring.RingService.Delete:input_type -> ring.DeleteRequest
	6,  // 3: ring.RingService.AddNode:input_type -> ring.AddNodeRequest
	8,  // 4: ring.RingService.RemoveNode:input_type -> ring.RemoveNodeRequest
	10, // 5: ring.RingService.GetShard:input_type -> ring.GetShardRequest
	1,  // 6: ring.RingService.Put:output_type -> ring.PutResponse
	3,  // 7: ring.RingService.Get:output_type -> ring.GetResponse
	5,  // 8: ring.RingService.Delete:output_type -> ring.DeleteResponse
	7,  // 9: ring.RingService.AddNode:output_type -> ring.AddNodeResponse
	9,  // 10: ring.RingService.RemoveNode:output_type -> ring.RemoveNodeResponse
	11, // 11: ring.RingService.GetShard:output_type -> ring.GetShardResponse
